!((e) => {
	...
	function K(e, t, n, i) {
		n.end(() => (v(e, "moveend", t), i && i()));
	}
	if (
		(m(document, "mousedown", (e) => {
			((e) => 1 === e.which && !e.ctrlKey && !e.altKey)(e) &&
				(((e) => !!i[e.target.tagName.toLowerCase()])(e) ||
					(m(document, o.move, X, e), m(document, o.cancel, Y, e)));
		}),
		m(document, "touchstart", (e) => {
