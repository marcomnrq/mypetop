	...
	!((e, i) => {
		...
		return (
			(n = (() => {
					...
					null == i && (i = {}),
						...
						(this.$wrapper = e("<div>", {
							class: ((t) => () => {
								var e;
								return (
									(e = ["" + t.options.baseClass].concat(
										t._getClasses(t.options.wrapperClass),
									)),
									e.push(
										t.options.state
											? t.options.baseClass + "-on"
											: t.options.baseClass + "-off",
									),
									null != t.options.size &&
										e.push(t.options.baseClass + "-" + t.options.size),
									t.options.disabled &&
										e.push(t.options.baseClass + "-disabled"),
									t.options.readonly &&
										e.push(t.options.baseClass + "-readonly"),
									t.options.indeterminate &&
										e.push(t.options.baseClass + "-indeterminate"),
									t.options.inverse && e.push(t.options.baseClass + "-inverse"),
									t.$element.attr("id") &&
										e.push(
											t.options.baseClass + "-id-" + t.$element.attr("id"),
										),
									e.join(" ")
								);
							})(this)(),
						...
						this.$element.on(
							...
							(
								(e) => () =>
									e.options.onInit.apply(t, arguments)
							)(this),
						),
						this.$element.on(
							...
							(
								(i) => (n) =>
									!1 === i.options.onSwitchChange.apply(t, arguments)
										? i.$element.is(":radio")
											? e("[name='" + i.$element.attr("name") + "']").trigger(
				...
				return (
					(t.prototype._constructor = t),
					(t.prototype.setPrevOptions = function () {
							...
							: this.options.disabled || this.options.readonly
								...
								: this.options.state &&
									...
									: (this.$element.is(":radio")
										...
										this.$element
											.prop("checked", t)
											.trigger("change.bootstrapSwitch", i),
										this.$element);
					}),
						...
						return "undefined" == typeof t
							...
							: (null != this.options.size &&
									this.$wrapper.removeClass(
										this.options.baseClass + "-" + this.options.size,
									),
					...
					(t.prototype.toggleIndeterminate = function () {
						return (
							...
							this.$wrapper.toggleClass(
								this.options.baseClass + "-indeterminate",
							),
							this._containerPosition(),
							this.$element
						);
					...
					(t.prototype.onColor = function (t) {
						...
						return (
							...
							"undefined" == typeof t
								? e
								: (null != e &&
										this.$on.removeClass(this.options.baseClass + "-" + e),
					...
					(t.prototype.offColor = function (t) {
						var e;
						return (
							(e = this.options.offColor),
							"undefined" == typeof t
								? e
								: (null != e &&
										this.$off.removeClass(this.options.baseClass + "-" + e),
					...
					(t.prototype.wrapperClass = function (t) {
						return "undefined" == typeof t
							...
							: (t || (t = e.fn.bootstrapSwitch.defaults.wrapperClass),
								this.$wrapper.removeClass(
					...
					(t.prototype.onInit = function (t) {
						return "undefined" == typeof t
							? this.options.onInit
							: (t || (t = e.fn.bootstrapSwitch.defaults.onInit),
					...
					(t.prototype.onSwitchChange = function (t) {
						return "undefined" == typeof t
							...
							: (t || (t = e.fn.bootstrapSwitch.defaults.onSwitchChange),
					...
					(t.prototype.destroy = function () {
						var t;
						return (
							(t = this.$element.closest("form")),
							t.length &&
								t.off("reset.bootstrapSwitch").removeData("bootstrap-switch"),
					...
					(t.prototype._width = function () {
						...
						return (
							...
							this.$label.width(
								(
									(t) => (i, n) =>
										"auto" !== t.options.labelWidth
											? t.options.labelWidth
											: e > n
												? e
												: n
								)(this),
					...
					(t.prototype._containerPosition = function (t, e) {
						return (
							null == t && (t = this.options.state),
							this.$container.css(
								"margin-left",
								((e) => () => {
									var i;
									return (
										(i = [0, "-" + e._handleWidth + "px"]),
					...
					(t.prototype._init = function () {
						...
						return (
							(t = ((t) => () => (
								t.setPrevOptions(),
								t._width(),
								t._containerPosition(null, () =>
									t.options.animate
										? t.$wrapper.addClass(t.options.baseClass + "-animate")
										: void 0,
								)
							))(this)),
					...
					(t.prototype._elementHandlers = function () {
						return this.$element.on({
							...
							"previousState.bootstrapSwitch": ((t) => (e) => (
								(t.options = t.prevOptions),
								t.options.indeterminate &&
									t.$wrapper.addClass(t.options.baseClass + "-indeterminate"),
								t.$element
									.prop("checked", t.options.state)
									.trigger("change.bootstrapSwitch", !0)
							))(this),
							"change.bootstrapSwitch": ((t) => (i, n) => {
								var o;
								return (
									i.preventDefault(),
									...
									o !== t.options.state
										? ((t.options.state = o),
											t.$wrapper
												.toggleClass(t.options.baseClass + "-off")
												.toggleClass(t.options.baseClass + "-on"),
											n
												? void 0
												: (t.$element.is(":radio") &&
														e("[name='" + t.$element.attr("name") + "']")
															.not(t.$element)
															.prop("checked", !1)
															.trigger("change.bootstrapSwitch", !0),
													t.$element.trigger("switchChange.bootstrapSwitch", [
														o,
													])))
										: void 0
								);
							})(this),
							"focus.bootstrapSwitch": ((t) => (e) => (
								e.preventDefault(),
								t.$wrapper.addClass(t.options.baseClass + "-focused")
							))(this),
							"blur.bootstrapSwitch": ((t) => (e) => (
								e.preventDefault(),
								t.$wrapper.removeClass(t.options.baseClass + "-focused")
							))(this),
							"keydown.bootstrapSwitch": ((t) => (e) => {
					...
					(t.prototype._labelHandlers = function () {
						return this.$label.on({
							...
							"mousedown.bootstrapSwitch touchstart.bootstrapSwitch": (
								(t) => (e) =>
									t._dragStart || t.options.disabled || t.options.readonly
										? void 0
										: (e.preventDefault(),
											e.stopPropagation(),
											(t._dragStart =
												(e.pageX || e.originalEvent.touches[0].pageX) -
												Number.parseInt(t.$container.css("margin-left"), 10)),
											t.options.animate &&
												t.$wrapper.removeClass(
													t.options.baseClass + "-animate",
												),
											t.$element.trigger("focus.bootstrapSwitch"))
							)(this),
									...
									if (t._dragStart)
										return (
											...
											t.options.animate &&
												t.$wrapper.addClass(t.options.baseClass + "-animate"),
											t._dragEnd
												? ((i = t._dragEnd > -(t._handleWidth / 2)),
													(t._dragEnd = !1),
													t.state(t.options.inverse ? !i : i))
												: t.state(!t.options.state),
											(t._dragStart = !1)
										);
								}
							)(this),
