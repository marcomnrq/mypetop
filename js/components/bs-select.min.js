...
!((e, t) => {
	...
	!((T) => {
		...
		function v(e, t) {
			...
			for (
				var s = T(t).filter((e, t) => t instanceof RegExp), n = 0, o = s.length;
				n < o;
				n++
			)
					...
					var t = "classList",
						...
						o = function () {
							...
							return {
								...
								toggle: (e, t) => i.toggleClass(e, t),
								contains: (e) => i.hasClass(e),
							};
						};
					if (n.defineProperty) {
		...
		var x,
			...
			E =
				...
				(S = RegExp(y, "g")),
				(e) => (
					(e = null == e ? "" : "" + e), $.test(e) ? e.replace(S, C) : e
				));
		function C(e) {
			return x[e];
		}
			...
			(te.prototype = {
				...
				createView: function (z, e, t) {
					...
					function W(e, t) {
						...
						if (
							...
							if (
								...
								(z || (!1 === u && t)) &&
									(p = !((e, i) =>
										e.length === i.length && e.every((e, t) => e === i[t]))(
										c,
										N.selectpicker.view.visibleElements,
									)),
								(t || !0 === u) && p)
					...
					W(i, !0),
						...
						T(window)
							...
							.on("resize" + F + "." + this.selectId + ".createView", () => {
						...
						? ((this.options.virtualScroll = !0),
							"function" == typeof l
								? l.call(
										this,
										(e) => {
											(n = this.buildData(e, i)), t.call(this, n);
										},
										e,
										s,
									)
								: Array.isArray(l) &&
									((n = this.buildData(l, i)), t.call(this, n)))
						: ((n = this.buildData(!1, i)), t.call(this, n));
				},
				...
				getSelectPosition: function () {
					...
					this.options.container && s.length && !s.is("body")
						? (((e = s.offset()).top += Number.parseInt(
								s.css("borderTopWidth"),
							)),
							(e.left += Number.parseInt(s.css("borderLeftWidth"))))
						: (e = { top: 0, left: 0 });
					...
					function e(e) {
						...
						l.$bsContainer
							...
							r.is("body")
								? (n = { top: 0, left: 0 })
								: (((n = r.offset()).top +=
										Number.parseInt(r.css("borderTopWidth")) - r.scrollTop()),
									(n.left +=
										Number.parseInt(r.css("borderLeftWidth")) -
										r.scrollLeft())),
						...
						T(window)
							...
							.on(
								"resize" +
									...
									this.selectId,
								() => {
									this.$newElement.hasClass(G.SHOW) && e(this.$newElement);
								},
							),
						this.$element.on("hide" + F, () => {
				...
				setOptionStatus: function (e) {
					if (
						...
						for (
							var i = 0;
							i < this.selectpicker.view.visibleElements.length;
							i++
						) {
							var s =
								this.selectpicker.current.data[
									i + this.selectpicker.view.position0
								];
							s.option &&
								(!0 !== e && this.setDisabled(s), this.setSelected(s));
						}
						this.options.source.data &&
							...
							if (
								...
								if (this.options.source.search)
									...
									var e = [],
										...
										n = [],
										o = this._searchStyle(),
										l = this.options.liveSearchNormalize;
									l && (i = I(i));
									for (var r = 0; r < this.selectpicker.main.data.length; r++) {
										var a = this.selectpicker.main.data[r];
										s[r] || (s[r] = k(a, i, o, l)),
											s[r] &&
									...
									for (var c = n.length; r < c; r++) {
										var d = n[r],
											h = n[r - 1],
											p =
												((a = this.selectpicker.main.data[d]),
												this.selectpicker.main.data[h]);
										("divider" !== a.type ||
											("divider" === a.type &&
												p &&
												"divider" !== p.type &&
												c - 1 !== r)) &&
											(this.selectpicker.search.data.push(a),
											e.push(this.selectpicker.main.elements[d]));
									}
									(this.activeIndex = void 0),
										(this.noScroll = !0),
										this.$menuInner.scrollTop(0),
										(this.selectpicker.search.elements = e),
										this.createView(!0),
										X.call(this, e, t);
								}
							else
