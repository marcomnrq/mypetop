...
!((e, t) => {
	...
	!((e) => {
		...
		function r(t, s) {
			...
			for (
				var r = e(s).filter((e, t) => t instanceof RegExp), a = 0, c = r.length;
				a < c;
				a++
			)
					...
					var i = t.Element.prototype,
						...
						n = function () {
							...
							return {
								...
								toggle: (e, i) => t.toggleClass(e, i),
								contains: (e) => t.hasClass(e),
							};
						};
					if (s.defineProperty) {
		...
		var O,
			...
			L =
				...
				(D = RegExp(T, "g")),
				(e) => (
					(e = null == e ? "" : "" + e), z.test(e) ? e.replace(D, A) : e
				)),
			N = {
				32: " ",
				48: "0",
		...
		(te.VERSION = "1.14.0-beta2"),
			(te.DEFAULTS = {
				...
				countSelectedText: (e, t) =>
					1 == e ? "{0} item selected" : "{0} items selected",
				maxOptionsText: (e, t) => [
					1 == e
			...
			(te.prototype = {
				...
				init: function () {
					...
					_++,
						...
						s.hasAttribute("required") &&
							this.$element.on("invalid.bs.select", () => {
								t.$button[0].classList.add("bs-invalid"),
									t.$element
										.on("shown.bs.select.invalid", () => {
											t.$element
												.val(t.$element.val())
				...
				createView: function (t, i, s) {
						...
						if (
							...
							if (
								...
								(t || (!1 === k && i)) &&
									...
									(x = !(
										g.length === b.length && g.every((e, t) => e === b[t])
									))),
								(i || !0 === k) && x)
							) {
								var S,
					...
					f(r, !0),
						...
						e(window)
							...
							.on("resize.bs.select." + this.selectId + ".createView", () => {
								l.$newElement.hasClass(G.SHOW) && f(l.$menuInner[0].scrollTop);
							});
				},
							...
							s && d
								...
								: "complete" !== document.readyState &&
									window.addEventListener("pageshow", () => {
										this.selectpicker.view.displayedValue !== i.value &&
											this.render();
									});
					}
					return t;
						...
						? ((this.options.virtualScroll = !0),
							"function" == typeof l
								? l.call(
										this,
										(i) => {
											(n = this.buildData(i, t)), e.call(this, n);
										},
										i,
										s,
									)
								: Array.isArray(l) &&
									((n = this.buildData(l, t)), e.call(this, n)))
						: ((n = this.buildData(!1, t)), e.call(this, n));
				},
				...
				getSelectPosition: function () {
					...
					this.options.container && n.length && !n.is("body")
						? (((t = n.offset()).top += Number.parseInt(
								n.css("borderTopWidth"),
							)),
							(t.left += Number.parseInt(n.css("borderLeftWidth"))))
						: (t = { top: 0, left: 0 });
						...
						this.setMenuSize(),
							this.options.liveSearch &&
								this.$searchbox
									...
									.on("input.setMenuSize propertychange.setMenuSize", () =>
										this.setMenuSize(),
									),
							"auto" === this.options.size
								? s
					...
					"auto" === this.options.width
						? requestAnimationFrame(() => {
								this.$menu.css("min-width", "0"),
									this.$element.on("loaded.bs.select", () => {
										this.liHeight(), this.setMenuSize();
										var t = this.$newElement.clone().appendTo("body"),
											i = t
												...
												.outerWidth();
										t.remove(),
											(this.sizeInfo.selectWidth = Math.max(
												this.sizeInfo.totalMenuWidth,
												i,
											)),
											this.$newElement.css(
						...
						l = (l) => {
							...
							this.$bsContainer
								...
								o.is("body")
									? (i = { top: 0, left: 0 })
									: (((i = o.offset()).top +=
											Number.parseInt(o.css("borderTopWidth")) - o.scrollTop()),
										(i.left +=
											Number.parseInt(o.css("borderLeftWidth")) -
											o.scrollLeft())),
								(s = l.hasClass(G.DROPUP) ? 0 : l[0].offsetHeight),
								(j.major < 4 || "static" === a) &&
									((r.top = t.top - i.top + s), (r.left = t.left - i.left)),
								(r.width = l[0].offsetWidth),
								this.$bsContainer.css(r);
						};
					this.$button.on("click.bs.dropdown.data-api", () => {
						this.isDisabled() ||
							...
							this.$bsContainer
								...
								.toggleClass(G.SHOW, !this.$button.hasClass(G.SHOW))
								.append(this.$menu));
					}),
						e(window)
							.off(
							...
							.on(
								"resize.bs.select." +
									...
									this.selectId,
								() => {
									this.$newElement.hasClass(G.SHOW) && l(this.$newElement);
								},
							),
						this.$element.on("hide.bs.select", () => {
				...
				clickListener: function () {
					...
					i.data("spaceSelect", !1),
						...
						this.$button.on("click.bs.dropdown.data-api", (e) => {
						...
						this.$menu.on("click", "." + G.POPOVERHEADER + " .close", () => {
				...
				liveSearchListener: function () {
					this.$button.on("click.bs.dropdown.data-api", () => {
						this.$searchbox.val() &&
							(this.$searchbox.val(""),
							(this.selectpicker.search.previousValue = void 0));
					}),
						this.$searchbox.on(
							...
							if (
								...
								if (this.options.source.search)
									...
									var i = [],
										...
										o = [],
										l = this._searchStyle(),
										r = this.options.liveSearchNormalize;
									r && (s = C(s));
									for (var a = 0; a < this.selectpicker.main.data.length; a++) {
										var c = this.selectpicker.main.data[a];
										n[a] || (n[a] = x(c, s, l, r)),
											n[a] &&
									...
									for (var d = o.length; a < d; a++) {
										var h = o[a],
											p = o[a - 1],
											u =
												((c = this.selectpicker.main.data[h]),
										...
										("divider" !== c.type ||
											("divider" === c.type &&
												...
												"divider" !== u.type &&
												d - 1 !== a)) &&
											(this.selectpicker.search.data.push(c),
											i.push(this.selectpicker.main.elements[h]));
									}
									(this.activeIndex = void 0),
										(this.noScroll = !0),
										this.$menuInner.scrollTop(0),
										(this.selectpicker.search.elements = i),
										this.createView(!0),
										X.call(this, i, t);
								}
							else
								this.selectpicker.search.previousValue &&
									(this.$menuInner.scrollTop(0), this.createView(!1));
							this.selectpicker.search.previousValue = t;
						});
				},
